...
import { Box, Card, CardActionArea, CardContent, CardMedia, Grid, Tab, Tabs, Typography, tabsClasses } from '@mui/material'
// Others
...
export const SeatInfo = (props: ISeatInfoProps) => {
  return (
    ...
    >
      <Grid item xs={6}>座位 : A03-1</Grid>
      <Grid item xs={6}>入座時間 : 17:30</Grid>
    </Grid>
  )
}
